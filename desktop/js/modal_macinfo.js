...
function macinfo_canClose() {
	...
	return confirm("{{Attention vous quittez une page ayant des données modifiées non sauvegardées. Voulez-vous continuer ?}}")
}

$('#table_macinfo tbody').on('click','.macinfoAction[data-action=remove]',function() {
